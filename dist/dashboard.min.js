...
var TooltipDialogs = (function() {
  ...
  var dialogBoxes = [{
    ...
    text: 'Hi Alice!\t \tWelcome to OpenTravel.\n'
      + ' I’m Watson.'+ '\t'+ 'I am here to help however I can.',
...
var Animations = (function() {
  ...
  function lightsOn() {
    ...
    Snap.select(idSelectors.headlights).animate({opacity: 0}, 300, mina.linear);
  }
  ...
  function buildMessageDomElement(newPayload, isUser) {
    ...
    var messageJson = {
      ...
      'children': [{
        ...
        'html': (isUser ? '<img src=\'/images/head.png\' />' + dataObj.text : dataObj.text)
      }]
    };
